...
const ChatBubble: React.FC<ChatBubbleProps> = ({ onClick, isOpen }) => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40">
      ...
      <button
        onClick={onClick}
className="bg-gradient-to-r from-pink-500 to-pink-600 hover:from-pink-600 hover:to-pink-700 text-white rounded-full w-16 h-16 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-700 hover:scale-105 animate-pulse-slow hover:animate-none"        aria-label={isOpen ? 'Fechar chat' : 'Abrir chat'}
      >
